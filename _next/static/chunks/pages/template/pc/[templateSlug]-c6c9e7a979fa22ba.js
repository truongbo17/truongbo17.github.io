(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[356], {
    22469: (e, t, n) => {
        "use strict";
        n.d(t, {A: () => h});
        var r = n(27002), i = n.n(r), o = n(14232), a = n(88907), s = n(3410), c = n(57257), l = n(89099), p = n(36423),
            d = n(37876);
        let u = function () {
            var e = (0, l.useRouter)(), t = (0, o.useState)(!0), n = t[0], r = t[1], u = (0, o.useState)(""), h = u[0],
                f = u[1], x = (0, o.useState)(window.innerWidth), m = x[0], b = x[1];
            return ((0, o.useEffect)(function () {
                var e = window.location.pathname, t = p.A.APP_URL || window.location.origin, n = window.location.search,
                    r = "", i = e.match(/\/s\/(?:pc\/)?([^/?]+)/);
                if (i && i[1]) r = "/s/".concat(i[1]); else {
                    var o = e.match(/\/showcase\/(?:pc\/)?([^/?]+)/);
                    if (o && o[1]) r = "/showcase/".concat(o[1]); else {
                        var a = e.match(/\/invite\/(?:pc\/)?([^/?]+)/);
                        a && a[1] && (r = "/invite/".concat(a[1]))
                    }
                }
                r && f("".concat(t).concat(r).concat(n)), b(window.innerWidth);
                var s = function () {
                    b(window.innerWidth)
                };
                    ...
                    children: [(0, d.jsx)("button", {
                        ...
                        children: [(0, d.jsx)("div", {
                            ...
                            children: (0, d.jsx)(a.A, {
                                ...
                                size: 120,
                                errorLevel: "M",
                                icon: "".concat(p.A.CDN_URL, "/assets/logos/logo-cinelove-192.png"),
                                iconSize: 32
                            })
                        }), (0, d.jsx)("p", {
        ...
        "use strict";
        n.d(t, {A: () => f});
        var r = n(63857), i = n(43081), o = n.n(i), a = n(30638), s = n(33413), c = n(14232), l = n(73301),
            p = n(10553), d = n(89099), u = n(46264), h = n(37876);
        let f = function (e) {
            var t, n = e.templateId, i = e.position, f = e.size, x = void 0 === f ? "medium" : f, m = e.isBlock,
                b = e.color, w = void 0 === b ? "#ff4d6d" : b, v = (0, c.useState)(!1), g = v[0], k = v[1],
                j = "authenticated" === (0, p.useSession)().status, y = (0, d.useRouter)(), O = (0, u.p)(),
                z = O.initializeFavorites, N = O.toggleFavorite, A = O.isFavorite;
            (0, c.useEffect)(function () {
                j && z()
            }, [j, z]);
            var S = (t = (0, r.A)(o().mark(function e() {
                var t;
                return o().wrap(function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        ...
                        case 2:
                            ...
                            return l.Ay.error("Vui l\xf2ng đăng nhập để th\xeam v\xe0o danh s\xe1ch y\xeau th\xedch"), y.push("/login?redirect=".concat(y.asPath)), e.abrupt("return");
                        case 6:
                            return k(!0), e.prev = 7, t = A(n), e.next = 11, N(n);
                        case 11:
                            e.sent ? l.Ay.success(t ? "Đ\xe3 x\xf3a khỏi danh s\xe1ch y\xeau th\xedch" : "Đ\xe3 th\xeam v\xe0o danh s\xe1ch y\xeau th\xedch") : l.Ay.error("Kh\xf4ng thể cập nhật trạng th\xe1i y\xeau th\xedch. Vui l\xf2ng thử lại sau."), e.next = 19;
                            break;
                        case 15:
                            e.prev = 15, e.t0 = e.catch(7), console.error("Error updating favorite status:", e.t0), l.Ay.error("Đ\xe3 xảy ra lỗi. Vui l\xf2ng thử lại sau.");
                        case 19:
            ...
            return (0, h.jsx)("button", {
                onClick: S,
                disabled: g,
                className: "".concat(void 0 !== m && m ? "block" : "absolute", " ").concat("small" === x ? "w-8 h-8" : "w-10 h-10", " ").concat({
                    "top-right": "top-3 right-3",
                    "top-left": "top-3 left-3"
                }[void 0 === i ? "top-right" : i], " z-40 flex items-center justify-center bg-white bg-opacity-70 backdrop-blur-sm rounded-full shadow-md hover:bg-opacity-90 transition-all duration-200"),
                "aria-label": A(n) ? "X\xf3a khỏi y\xeau th\xedch" : "Th\xeam v\xe0o y\xeau th\xedch",
                children: A(n) ? (0, h.jsx)(a.A, {
                    style: {
                        fontSize: E,
                        color: w
                    }
                }) : (0, h.jsx)(s.A, {style: {fontSize: E, color: w}})
            })
        }
    }, 62684: (e, t, n) => {
        (window.__NEXT_P = window.__NEXT_P || []).push(["/template/pc/[templateSlug]", function () {
            return n(83450)
        }])
    }, 83450: (e, t, n) => {
        "use strict";
        n.r(t), n.d(t, {__N_SSP: () => T, default: () => _});
        var r = n(59860), i = n(42969), o = n(27925), a = n(63857), s = n(43081), c = n.n(s), l = n(66125),
            p = n(14232), d = n(6428), u = n.n(d), h = n(33845), f = n.n(h), x = n(16752), m = n(4105), b = n(22469),
            w = n(89099), v = n(733), g = n(62867), k = n(32939), j = n(43107), y = n(83240), O = n(36956),
            z = n(89862), N = n(32716), A = n(54737), S = n(37876), E = ["editorViewportWidth"];
        ...
        var T = !0;
        let _ = function (e) {
            var t = e.templateData, n = e.templateId, i = e.canonicalUrl, s = (0, w.useRouter)(),
                d = (0, v.bi)().setPageId, h = "true" === s.query.onlyPreview, P = "true" === s.query.hide;
            (0, p.useEffect)(function () {
                var e;
                d(n), (e = (0, a.A)(c().mark(function e() {
            ...
            var T = JSON.parse(u().decompress(u().decodeBase64(t.templateData))), _ = (0, p.useState)(!0), C = _[0],
                R = _[1], L = (0, p.useMemo)(function () {
                    return (0, A.n)(T)
                }, []), Y = L.hasEnvelope && L.preventScrollUntilOpened, D = (0, p.useState)(T), I = D[0], W = D[1],
                M = (0, p.useState)(0), V = M[0], F = M[1];
            (0, p.useEffect)(function () {
                var e = function () {
                    R(!0);
                    var e = parseInt(T.ROOT.props.width), t = parseInt(T.ROOT.props.height), n = V / e,
                        i = Math.max(t * n, .9 * window.innerHeight), a = Object.entries(T).reduce(function (e, t) {
                            var r = (0, o.A)(t, 2), i = r[0], a = r[1];
                            ...
                            return e[i] = q(q({}, a), {}, {props: s}), e
                        }, {}), s = T.ROOT.props, c = (s.editorViewportWidth, (0, r.A)(s, E));
                    a.ROOT = q(q({}, T.ROOT), {}, {
                        props: q(q({}, c), {}, {
                            width: V,
                            height: i
                ...
                var e = function () {
                    var e = Math.round(.55 * (.9 * window.innerHeight));
                    e > 500 ? F(500) : F(e)
                };
            ...
            var B = "".concat(t.templateName, " - ").concat((0, N.g)(t.categoryId), " miễn ph\xed");
            return (0, S.jsxs)(S.Fragment, {
                children: [(0, S.jsx)(g.bV, {
                    title: B,
                    titleTemplate: "%s | CineLove",
                    defaultTitle: "CineLove",
                    description: "".concat(B, " - Thiệp online tr\xean CineLove"),
                    canonical: i,
                    openGraph: {
                        type: "website",
                        url: i,
                    ...
                    children: (0, S.jsx)(m.A, {
                        ...
                        children: (0, S.jsxs)(k.Z, {
                            ...
                            children: [C && (0, S.jsx)("div", {
                                ...
                                resolver: z.K6,
                                enabled: !1,
                                children: (0, S.jsx)(l.wI, {data: I}, I.ROOT.props.width)
                            })]
                        })
                    })
                }), (0, S.jsxs)("div", {
